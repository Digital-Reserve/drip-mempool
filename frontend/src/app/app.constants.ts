...
export const specialBlocks = {
  '0': {
    labelEvent: 'Genesis',
    labelEventCompleted: 'The Genesis of DRIP - December 25, 2025',
    networks: ['mainnet'],
  },
  '1': {
    labelEvent: 'Taproot Active',
    labelEventCompleted: 'Taproot has been active since block 1!',
    networks: ['mainnet'],
  },
  '35000': {
    labelEvent: 'Difficulty Fork',
    labelEventCompleted: 'Difficulty adjustment changed to every 3.5 days',
    networks: ['mainnet'],
  },
  '210000': {
    labelEvent: 'DRIP\'s 1st Halving',
    labelEventCompleted: 'Block Subsidy has halved to 25 DRIP per block',
    networks: ['mainnet'],
  },
  '420000': {
    labelEvent: 'DRIP\'s 2nd Halving',
    labelEventCompleted: 'Block Subsidy has halved to 12.5 DRIP per block',
    networks: ['mainnet'],
  },
  '630000': {
    labelEvent: 'DRIP\'s 3rd Halving',
    labelEventCompleted: 'Block Subsidy has halved to 6.25 DRIP per block',
    networks: ['mainnet'],
  },
  '840000': {
    labelEvent: 'DRIP\'s 4th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 3.125 DRIP per block',
    networks: ['mainnet'],
  },
  '1050000': {
    labelEvent: 'DRIP\'s 5th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 1.5625 DRIP per block',
    networks: ['mainnet'],
  },
  '1260000': {
    labelEvent: 'DRIP\'s 6th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 0.78125 DRIP per block',
    networks: ['mainnet'],
  },
  '1470000': {
    labelEvent: 'DRIP\'s 7th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 0.390625 DRIP per block',
    networks: ['mainnet'],
  },
  '1680000': {
    labelEvent: 'DRIP\'s 8th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 0.1953125 DRIP per block',
    networks: ['mainnet'],
  },
  '1890000': {
    labelEvent: 'DRIP\'s 9th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 0.09765625 DRIP per block',
    networks: ['mainnet'],
  },
  '2100000': {
    labelEvent: 'DRIP\'s 10th Halving',
    labelEventCompleted: 'Block Subsidy has halved to 0.04882812 DRIP per block',
    networks: ['mainnet'],
  },
};
