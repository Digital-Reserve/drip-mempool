...
export class SeoService {
  network = '';
  baseTitle = 'DRIP Explorer';
  baseDescription = 'Explore the DRIP blockchain - real-time mempool visualization, transaction tracking, and mining statistics.';
  baseDomain = 'drip.explorer';
