...
export class PriceChartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.timespan) {
      ...
      this.seoService.setTitle($localize`:@@price-chart.title:DRIP Price`);
      this.seoService.setDescription($localize`:@@price-chart.description:See the DRIP price visualized over time.`);
  ...
  onSaveChart() {
    ...
    }), `drip-price-${this.currentTimespan}-${Math.round(now.getTime() / 1000)}.svg`);
    // @ts-ignore
